...
const About = () => {
    return (
        <div className="m-4 text-light" align="justify" text>
            ...
            <p>I had shelved this project for many months until I found the skills to make it a reality, but more importantly I found a reason* to finally build it, and that reason brings a lot of <i>hope</i> in my life! I sometimes also tend to name things based on the things around me (I'm lazy), so the name is partly inspired by the <i>Star Wars: Episode IV - A New Hope</i> poster on my wall.</p>
            <small><p className="text-secondary">* something about starred messages!</p></small>
