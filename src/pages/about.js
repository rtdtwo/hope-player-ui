...
const About = () => {
    return (
        <div className="m-4 text-light" align="justify" text>
            ...
            <h5 className="headline-light mt-5">Why <i>Hope</i>?</h5>
            <p>I had shelved this project for many months until I found the skills to make it a reality, but more importantly I found a reason to finally build it, and that reason brings a lot of <i>hope</i> in my life! I sometimes tend to name things based on the things around me (I'm lazy), so it is also partly inspired by the <i>Star Wars: Episode IV - A New Hope</i> poster on my wall.</p>
            <h5 className="headline-light mt-5">Free and open-source</h5>
            <p>Hope Player is always free, and is open-sourced. I do not earn any royalty from it, but donations are welcome!</p>
            <h5 className="headline-light mt-5">A word of caution</h5>
